<template>
  <div class="col-xs-6 col-sm-3 sidebar-offcanvas" role="navigation">
    <ul class="list-group panel">
      ...
      <li class="list-group-item"><a href="icons.html"><i class="glyphicon glyphicon-certificate"></i>应用管理</a>
      </li>
      <li class="list-group-item"><a href="list.html"><i class="glyphicon glyphicon-th-list"></i>同步配置
      </a></li>
      <li class="list-group-item"><a href="forms.html"><i class="glyphicon glyphicon-list-alt"></i>数据字典</a></li>
      <li class="list-group-item"><a href="timeline.html"><i class="glyphicon glyphicon-indent-left"></i>关联关系</a>
      </li>
